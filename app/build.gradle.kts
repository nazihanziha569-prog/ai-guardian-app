...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "ANTHROPIC_KEY", "\"${localProps["ANTHROPIC_KEY"]}\"")
        buildConfigField("String", "GEMINI_KEY", "\"${localProps["GEMINI_KEY"]}\"")
        buildConfigField("String", "GROQ_KEY", "\"${localProps["GROQ_KEY"]}\"")
    }
    buildTypes {
        release {
